...
ok("calendar-day range function","function rangeEnd(days)" in html)
ok("7D stat uses calendar range",'rangeEnd(7)' in html)
ok("editorial agenda layout","agenda-intro" in html and "Market Agenda" in html)
